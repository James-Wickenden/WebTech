...
async function create() {
    try {
        ...
        await db.run("create table if not exists uploads (upload_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, user_id INTEGER NOT NULL, name TEXT NOT NULL, category TEXT NOT NULL, other_spec TEXT, upload_date DATE, description TEXT, no_downloads INT, no_favourites INT, comments TEXT, FOREIGN KEY(user_id) REFERENCES users(user_id));");
        var as;
