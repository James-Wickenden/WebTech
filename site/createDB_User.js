...
async function create() {
    try {
        ...
        await db.run("create table if not exists users (user_id INT PRIMARY KEY, username TEXT, password TEXT, is_moderator BOOLEAN, join_date DATE, about TEXT, submissions TEXT);");
        var as;
