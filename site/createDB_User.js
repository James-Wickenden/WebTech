...
async function create() {
  try {
    ...
    await db.run("create table if not exists users (user_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT, is_moderator BOOLEAN, join_date TEXT, about TEXT, submissions TEXT);");
    var as;
